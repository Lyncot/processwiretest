...
$(".equalizer").equalize({children: ".equalize"});
...
function createDiv(){
    ...
    div.innerHTML = '<div class="grid-container"><div class="grid-x"><div class="cell small-12 medium-3 large-3"><h4><i class="fal fa-cookie-bite"></i> This site uses cookies</h4></div><div class="cell small-12 medium-6 large-7"><p>Our website uses cookies. ' +
                    'By continuing we assume your permission to deploy cookies, as detailed in our ' + 
                    '<a href="/cookies-policy" rel="nofollow" title="Cookies Policy">cookies policy</a>.</p></div> ' +
                    '<div class="cell small-12 medium-3 large-2 text-center"><a class="button cta-btn close-cookie-banner" href="javascript:void(0);" onclick="removeMe();"><i class="fal fa-check-square"></i> Continue</a></div></div></div>';    
